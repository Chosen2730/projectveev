...
const Terms = () => {
  ...
  return (
    <div className='max-w-4xl mx-auto p-6 text-gray-700'>
      <h1 className='text-2xl uppercase font-bold'>TERMS OF SERVICE</h1>
      <div className='text-sm'>
        <p className='my-3'>
          This website is operated by Veev Clothiers. Throughout the site, the
          terms “we”, “us”, and “our” refer to Veev Clothiers. Veev Clothiers
          ...
          Service.
          <br />
          <br /> If you do not agree to all the terms and conditions of this
          ...
          expressly limited to these Terms of Service. Any new features or tools
          which are added to the current store shall also be subject to the
          Terms of Service. You can review the most current version of the Terms
          of Service at any time on this page. We reserve the right to update,
          change or replace any part of these Terms of Service by posting
          updates and/or changes to our website. <br />
          <br />
          ...
          of any changes constitutes acceptance of those changes. <br />
          <br /> Our store is hosted on Shopify Inc. They provide us with the
        ...
        <p className='my-3'>
          ...
          information. <br />
          <br /> Any reliance on the material on this site is at your own risk.
        ...
        <p className='my-3'>
          ...
          any part or content thereof) without notice at any time. <br />
        ...
        <p className='my-3'>
          ...
          possible the colours and images of our products that appear at the
          store. <br />
          <br /> We cannot guarantee that your computer monitor's display of any
          colour will be accurate. We reserve the right, but are not obligated,
          ...
          any products or services that we offer. <br />
          <br /> All descriptions of products or product pricing are subject to
        ...
        <p className='my-3'>
          ...
          <br />
          <br /> In the event that we make a change to or cancel an order, we
          ...
          and account information for all purchases made at our store. You agree
          ...
          <br /> For more detail, please review our Returns & Exchanges Policy.
        </p>
        <h2 className='my-4 text-uppercase font-bold'>
        ...
        <p className='my-4'>
          ...
          without any endorsement. <br />
          <br /> We shall have no liability whatsoever arising from or relating
          to your use of optional third-party tools. Any use by you of optional
        ...
        <p className='my-3'>
          ...
          us. <br />
          <br /> We are not responsible for examining or evaluating the content
          ...
          other materials, products, or services of third-parties. <br />
          <br />
          ...
          <br />
          <br /> Complaints, claims, concerns, or questions regarding
        ...
        <p className='my-3'>
          ...
          comments that you forward to us. <br />
          <br /> We are and shall be under no obligation (1) to maintain any
          comments in confidence; (2) to pay compensation for any comments; or
          ...
          website. <br />
          <br /> You may not use a false e mail address, pretend to be someone
        ...
        <p>
          ...
          shipping charges, transit times and availability. <br />
          <br /> We reserve the right to correct any errors, inaccuracies or
          ...
          order). <br />
          <br /> We undertake no obligation to update, amend or clarify
        ...
        <p className='my-3'>
          ...
          possibility. <br />
          <br /> Because some states or jurisdictions do not allow the exclusion
        ...
        <p className='my-3'>
          ...
          provision. <br />
          <br /> These Terms of Service and any policies or operating rules
        ...
        <p className='my-3'>
          ...
          to check our website periodically for changes. <br />
          <br /> Your continued use of or access to our website or the Service
